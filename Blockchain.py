...
class Blockchain:
    ...
    def __init__(self):
        ...
        self.chain.append(genesis_block) #append it to chain

    
    # Add a block to the chain after verfying and validating it.
    #  Input : block and hash of that block
    ...
    # will add the block to the chain.  verifying, validating and adding the block.
    def mine(self):
